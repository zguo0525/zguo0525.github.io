...
- **Gen-VQA: Generative Visual Question Answering with Abstract Scenes**  
  ...
  [report](https://github.com/Yang-YiFan/vqa-gan){:.chip} · [code](https://github.com/Yang-YiFan/vqa-gan){:.chip}
...
- **Hardware Efficient Quantum Computing via Circuit Decomposition**  
  ...
  [code](https://github.com/zguo0525/Hardware-Efficient-Quantum-Computing-via-Circuit-Decomposition){:.chip}
